				...
				<Frame>
					...
					<Carousel showIndex={this.state.showIndex} nav={this.renderNav()} width={configStyles.imageWidth}>
						<Slide image={require('./images/1.jpg')} title="Imperial Mockery">
							...
							Empire. These objects were immediately removed from the reflecting pool in Coruscant's
						...
						<Slide image={require('./images/3.jpg')} title="Master and Apprentice">
							Internships work! When determining a career path, it is wise to first find someone currently
							in that line of work. They will likely be able to show you what it's really like before you
							commit your future.
						</Slide>
						<Slide image={require('./images/4.jpg')} title="Battle of Coruscant">
							Modelers ran out of the pre-Empire model Star Destroyers in this reenactment of the Battle
							of Coruscant. Various plans for future machines of war were used as filler.
						</Slide>
						<Slide image={require('./images/5.jpg')} title="The Wiles of the Forest">
							...
							possibility rotating troopers stationed on the forest moons of Endor after several
							rotations.
						</Slide>
					</Carousel>
				</Frame>
